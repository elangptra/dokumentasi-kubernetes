...
- Tekan `Esc`, ketik `:wq`, lalu `Enter` untuk menyimpan dan keluar
 ...
 jika cara instalasi metrics server diatas belum bisa mengembalikan resource dari semua node yang tersedia ketika menjalankan `kubectl top nodes`, gunakan cara berikut :
